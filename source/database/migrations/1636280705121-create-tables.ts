...
export class CreateTables1636280705121 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('CREATE TABLE "curlys"."images" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a5bd7999989d2a6bb88924613ba" PRIMARY KEY ("uuid")); COMMENT ON COLUMN "curlys"."images"."content" IS \'image/webp\'');
        await queryRunner.query('CREATE TABLE "curlys"."reviews" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "photo_uuid" uuid, "dessert_uuid" uuid NOT NULL, "rating" smallint NOT NULL, "text" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_ac378d6d824b2ad91f1f2492bf" UNIQUE ("photo_uuid"), CONSTRAINT "CHK_5f4c2550e5fc2df5b18d7d3ada" CHECK (rating BETWEEN 1 AND 5), CONSTRAINT "PK_f2ccc5d85d7f3393c7f975395f7" PRIMARY KEY ("uuid"))');
        await queryRunner.query('CREATE TABLE "curlys"."desserts" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" character varying(50) NOT NULL, "name" character varying(100) NOT NULL, "description" text NOT NULL, "protein" integer NOT NULL, "fats" integer NOT NULL, "carbohydrates" integer NOT NULL, "calories" integer NOT NULL, "quantity" smallint NOT NULL, "price" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fe94ce2dcaac003ed859cdca511" UNIQUE ("slug"), CONSTRAINT "CHK_82a97de313a8a2b83c178a108f" CHECK (price > 0), CONSTRAINT "CHK_63068c646d682d7ac25977dc58" CHECK (quantity = 2 OR quantity = 4 OR quantity = 6), CONSTRAINT "CHK_b0d4ecc28b6d93b52f70537116" CHECK (calories > 0), CONSTRAINT "CHK_b8ff1983e92d40ac14e63ecaa5" CHECK (carbohydrates > 0), CONSTRAINT "CHK_cb3f78a9cd617e8376b78c6bfb" CHECK (fats > 0), CONSTRAINT "CHK_6dcaf54984503c83146ad59387" CHECK (protein > 0), CONSTRAINT "PK_b36f294d5be92c08827042a0acd" PRIMARY KEY ("uuid")); COMMENT ON COLUMN "curlys"."desserts"."protein" IS \'белки\'; COMMENT ON COLUMN "curlys"."desserts"."fats" IS \'жиры\'; COMMENT ON COLUMN "curlys"."desserts"."carbohydrates" IS \'углеводы\'; COMMENT ON COLUMN "curlys"."desserts"."calories" IS \'калорийность\'');
        await queryRunner.query('CREATE TABLE "curlys"."instagram" ("shortcode" character varying(100) NOT NULL, "photo_uuid" uuid, "created_at" TIMESTAMP NOT NULL, CONSTRAINT "REL_91aa4d7a1bb85d98220d0f2c3f" UNIQUE ("photo_uuid"), CONSTRAINT "PK_1a5ff75d027a2f9b2e53b50159e" PRIMARY KEY ("shortcode"))');
